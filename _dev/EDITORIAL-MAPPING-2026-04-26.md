...
## Nachtrag – Phase 1 umgesetzt (26. April 2026)

Phase 1 wurde vollständig implementiert und als Pull Request #259 eingereicht.

| Phase | Inhalt                                                                              | Status                                        |
| ----- | ----------------------------------------------------------------------------------- | --------------------------------------------- |
| **0** | Inventar + Mapping-Bericht                                                          | erledigt                                      |
| **1** | Token-Layer: Background, Heading-Schrift, Border-Radien, Kicker/Lede/Rule-Utilities | PR #259 – ausstehend: visueller Check + Merge |
| **2** | Komponenten-Patterns auf Home, Verstehen, Genesung, Kommunizieren, Selbstfürsorge   | offen                                         |
| **3** | Verifikation und Release                                                            | offen                                         |

**Commits auf `feature/editorial-design-phase1`:**

| Commit    | Inhalt                                                                                     |
| --------- | ------------------------------------------------------------------------------------------ |
| `b295230` | Font-Migration: Source Serif 4 installiert, DM Serif Display entfernt                      |
| `d9bf0ac` | Background warm, h1/h2-Refinements, Utilities `.kicker`/`.lede`/`.rule`/`.prose-editorial` |
| `c0bc6ca` | `--radius` 0.75rem → 0.5rem                                                                |

**Ausstehend nach Merge:**
Visueller Check Soforthilfe + Notfallkarte (App-Modus-Kontrollseiten), WCAG-AA-Kontrast auf neuem Cream-Background, Mobile Safari.
