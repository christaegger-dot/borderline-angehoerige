import { Eye, Ear, Hand, Wind as Nose, Coffee, CheckCircle2 } from "lucide-react";
...
const steps: GroundingStep[] = [
  ...
  },
  {
    ...
    instruction: "Benennen Sie 3 Dinge, die Sie berühren oder körperlich spüren.",
  ...
  },
  {
    ...
    prompt: "Vielleicht ist noch ein Geschmack im Mund oder von einem Getränk da.",
  },
];
    ...
    <Card className="bg-gradient-to-br from-slate-light/30 to-slate-wash/20 border-slate-dark">
      <CardContent className="p-6">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-5">
          Diese Übung kann helfen, sich in einem angespannten Moment wieder stärker im Hier und Jetzt zu verankern.
          Gehen Sie die Schritte in Ihrem eigenen Tempo durch. Es braucht keinen Timer und kein «richtiges» Ergebnis.
        </p>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground leading-relaxed mb-1">{step.instruction}</p>
        ...
        <p className="text-xs text-muted-foreground mt-4 flex items-start gap-2">
          ...
          Wenn Sie merken, dass die Übung Sie eher zusätzlich stresst, lassen Sie sie weg und orientieren Sie sich stattdessen an etwas Einfacherem:
          beide Füsse spüren, langsamer ausatmen oder eine vertraute Person kontaktieren.
        </p>
      </CardContent>
    </Card>
  );
