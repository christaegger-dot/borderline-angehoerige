import { Eye, MessageSquare, Sparkles, History, Users, Star, CheckCircle2, AlertTriangle } from "lucide-react";
...
const stufen: Stufe[] = [
  {
    ...
    soGehts: ["Kurz innehalten, Blick und Körper zuwenden", "Handy weg, nicht nebenbei argumentieren", "Ruhige Stimme"],
    beispielsaetze: ["«Ich bin da. Sag mir, was los ist.»", "«Ich möchte dich verstehen. Erzähl.»"],
  ...
  },
  {
    ...
    soGehts: ["Vorsichtige Vermutung äussern", "Korrektur erlauben statt behaupten"],
    beispielsaetze: ["«Ich frage mich, ob da auch Angst dabei ist.»", "«Bist du gerade eher verletzt als wütend?»"],
    typischerFehler: "Gedankenlesen als Tatsache darstellen.",
    dialog: {
      betroffener: "Mein Chef hat mich vor allen kritisiert. Egal.",
      angehoeriger: "Kann es sein, dass du nicht nur enttäuscht, sondern auch verletzt bist?",
    },
  },
  {
    level: 4,
    ...
    dialog: {
      ...
      angehoeriger: "Nach dem, was du erlebt hast, ist nachvollziehbar, dass Vertrauen so schwer ist.",
    },
  },
  {
    level: 5,
    ...
    dialog: {
      ...
      angehoeriger: "Nein. Dass dich das trifft, ist verständlich. Und ich sage dir auch ehrlich, wo meine Grenze ist.",
    },
  },
  {
    level: 6,
    ...
    dialog: {
      ...
      angehoeriger: "Ich nehme dich ernst. Lass uns zusammen schauen, was gerade hilft.",
    },
  },
];
  ...
  return (
    <div className="mt-6 space-y-4">
      <p className="text-sm text-muted-foreground">
        Die sechs Stufen sind kein Schema, das immer vollständig abgearbeitet werden muss. Sie helfen eher dabei,
        den eigenen Ton zu klären: zuerst Präsenz und Verstehen, dann bei Bedarf mehr Einordnung und Grenze.
      </p>
          ...
          <Card key={stufe.level} className="border-border/50">
            <CardContent className="p-5">
              ...
              <div className="grid gap-4 md:grid-cols-2 mb-4">
                <div>
                  <p className="text-xs font-medium text-muted-foreground mb-2">So kann es aussehen</p>
              ...
              <div className="mb-4">
                ...
                <div className="space-y-2">
                  {stufe.beispielsaetze.map((satz, i) => (
                    <div key={i} className="rounded-md px-3 py-2 text-sm font-medium" style={{ backgroundColor: `color-mix(in oklch, ${stufe.color} 10%, white)`, color: stufe.color }}>
                      {satz}
                    </div>
                  ))}
                </div>
              ...
              <div className="rounded-lg bg-muted/30 p-4 space-y-3">
                ...
                <div className="flex items-start gap-2">
                  <span className="text-xs font-medium text-sage-dark bg-sage-wash px-2 py-0.5 rounded flex-shrink-0">A</span>
                  <p className="text-sm text-foreground font-medium">{stufe.dialog.angehoeriger}</p>
                </div>
              </div>
            </CardContent>
          </Card>
