        ...
        <div className="container">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm font-medium text-foreground/60">Ihre Meinung zählt</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              Ihre Erfahrungen und Anregungen helfen uns, diese Website für andere Angehörige 
              noch hilfreicher zu gestalten.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <Card className="bg-sage-light/30 border-sage/30">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-6 leading-relaxed max-w-md mx-auto">
                    ...
                    Verbesserungsvorschläge oder Fehlermeldungen.
                  </p>
                  <a 
                ...
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>Hinweise auf Fehler oder Verbesserungsmöglichkeiten</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
