...
const glossaryTerms: GlossaryTerm[] = [
  // Therapie & Behandlung
  {
    ...
    abbreviation: "DBT",
    category: "therapie",
    definition: "Die DBT ist die am besten erforschte Therapieform für Borderline. Sie wurde von Marsha Linehan entwickelt und kombiniert Verhaltenstherapie mit Achtsamkeitspraktiken. Der Begriff 'dialektisch' bezieht sich auf die Balance zwischen Akzeptanz (so wie es ist) und Veränderung (was besser werden kann).",
    example: "In der DBT lernen Betroffene konkrete Fertigkeiten (Skills) zur Emotionsregulation, Stresstoleranz, zwischenmenschlichen Effektivität und Achtsamkeit.",
  ...
  },
  {
    term: "Mentalisierung",
    category: "therapie",
    definition: "Die Fähigkeit, das eigene Verhalten und das Verhalten anderer Menschen als Ausdruck von Gedanken, Gefühlen, Wünschen und Absichten zu verstehen. Bei Menschen mit Borderline ist diese Fähigkeit oft beeinträchtigt, besonders in emotional aufgeladenen Situationen.",
    example: "Wenn jemand mentalisiert, denkt er: 'Sie ist vielleicht gereizt, weil sie einen stressigen Tag hatte' – statt: 'Sie hasst mich'."
  },
  {
    term: "Remission",
    category: "therapie",
  ...
  },
  {
    term: "Invalidierung",
    category: "kommunikation",
    definition: "Das Gegenteil von Validierung: Die Gefühle oder Erfahrungen einer Person werden abgewertet, ignoriert oder als übertrieben dargestellt. Invalidierung kann Krisen verschärfen und ist besonders schmerzhaft für Menschen mit Borderline.",
    example: "Invalidierende Aussagen: 'Das ist doch nicht so schlimm', 'Du übertreibst mal wieder', 'Andere haben es viel schwerer'."
  },
  ...
  // Symptome & Muster
  {
    ...
    category: "symptome",
    definition: "Die Schwierigkeit, Emotionen zu regulieren – sie werden intensiver erlebt, schneller ausgelöst und klingen langsamer ab. Dies ist ein Kernmerkmal von Borderline und erklärt viele der beobachtbaren Verhaltensweisen.",
    example: "Eine kleine Enttäuschung kann sich anfühlen wie ein Weltuntergang. Die Emotion ist real und intensiv – nur die Auslöser-Reaktion-Verhältnis ist anders.",
  ...
  },
  {
    term: "Splitting",
    category: "symptome",
    definition: "Ein Denkmuster, bei dem Menschen oder Situationen als 'ganz gut' oder 'ganz schlecht' wahrgenommen werden, ohne Grautöne. Dies ist keine bewusste Manipulation, sondern eine automatische Reaktion auf emotionale Überforderung.",
    example: "Gestern war der Partner 'der beste Mensch der Welt', heute nach einem Streit 'hat er mich nie geliebt'. Beide Extreme fühlen sich im Moment absolut wahr an.",
    relatedPage: "/verstehen",
    relatedPageTitle: "Borderline verstehen"
  },
  {
    ...
    category: "symptome",
    definition: "Eine intensive, oft überwältigende Angst vor dem Verlassenwerden – real oder eingebildet. Diese Angst kann zu verzweifelten Versuchen führen, Beziehungen aufrechtzuerhalten, oder paradoxerweise dazu, andere zuerst zu verlassen.",
    example: "Schon eine kurze Verzögerung bei einer Antwort kann Panik auslösen: 'Er antwortet nicht – er will mich verlassen!'",
    relatedPage: "/verstehen",
    relatedPageTitle: "Borderline verstehen"
  },
  {
    term: "Dissoziation",
    category: "symptome",
    definition: "Ein Zustand, in dem sich Menschen von sich selbst, ihrem Körper oder ihrer Umgebung abgetrennt fühlen. Es ist eine Schutzreaktion des Gehirns auf überwältigende Emotionen oder Stress.",
    example: "Betroffene beschreiben es als 'neben sich stehen', 'wie in Watte gepackt sein' oder 'die Welt wirkt unwirklich'."
  },
  {
    term: "Identitätsdiffusion",
    category: "symptome",
    definition: "Ein instabiles oder unklares Selbstbild. Menschen mit Borderline haben oft Schwierigkeiten zu beschreiben, wer sie sind, was sie wollen oder was ihre Werte sind – unabhängig von anderen Menschen.",
    example: "'Ich weiss nicht, wer ich bin, wenn ich alleine bin. Ich übernehme immer die Interessen meines Partners.'",
    relatedPage: "/verstehen",
    relatedPageTitle: "Borderline verstehen"
  },
  ...
  // Selbsthilfe & Angehörige
  {
    ...
    definition: "Bewusste Handlungen, um die eigene körperliche, emotionale und mentale Gesundheit zu erhalten. Für Angehörige von Menschen mit Borderline ist Selbstfürsorge keine Selbstsucht, sondern notwendig, um langfristig unterstützen zu können.",
    example: "Regelmässige Pausen, eigene Hobbys pflegen, professionelle Unterstützung suchen, Grenzen setzen.",
  ...
  },
  {
    term: "Grenzen setzen",
    category: "selbsthilfe",
    definition: "Klare Kommunikation darüber, welches Verhalten akzeptabel ist und welches nicht – mit konsequenter Umsetzung. Grenzen schützen beide Seiten und sind ein Zeichen von Respekt, nicht von Ablehnung.",
    example: "'Ich bin bereit, mit dir zu sprechen, aber nicht, wenn du schreist. Wenn du ruhiger bist, bin ich wieder da.'",
    relatedPage: "/grenzen",
  ...
  },
  {
    ...
    category: "selbsthilfe",
    definition: "Eine Metapher für die Rolle von Angehörigen: Sie können ein Leuchtturm sein – stabil, verlässlich, orientierungsgebend – aber sie können nicht das Schiff steuern. Die Verantwortung für die Genesung liegt beim Betroffenen.",
    example: "'Ich bin da, ich leuchte, ich zeige die Richtung – aber ich kann nicht für dich schwimmen.'",
    relatedPage: "/",
...
export default function Glossar() {
  ...
  // Sort alphabetically
  const sortedTerms = [...filteredTerms].sort((a, b) => a.term.localeCompare(b.term, 'de'));
        ...
        <div className="container">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm font-medium text-foreground/60">{glossaryTerms.length} Begriffe</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              Fachbegriffe verständlich erklärt – für Angehörige, die sich neu einlesen oder 
              bestimmte Konzepte nachschlagen möchten.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container">
          {sortedTerms.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">Keine Begriffe gefunden für "{searchTerm}"</p>
            </div>
          ) : (
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    Bei Fragen zur Diagnose oder Behandlung wenden Sie sich bitte an Fachpersonen.
                  </p>
                </div>
              </div>
            </CardContent>
