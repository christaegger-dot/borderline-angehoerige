        ...
        >
          <EditorialProse>
            ...
            <p>
              ...
              Randi Kreger (deutsche Ausgabe) beschreibt dieses Gefühl treffend:
              das ständige Auf-der-Hut-Sein, die Angst vor dem nächsten
          ...
          <div className="mt-8">
            <EvidenceNote
              ...
              sources={[
                ...
                {
                  label:
                    "Mason & Kreger, Stop Walking on Eggshells / Schluss mit dem Eiertanz (deutsche Ausgabe)",
                  type: "wissenschaft",
                },
                {
                  label:
