...
export default function UnterstuetzenAlltag() {
  ...
  return (
    <Layout>
      ...
      <EditorialSection variant="cream">
        ...
        <EditorialSection.Body>
          ...
          >
            ...
            <LastVerifiedBadge path="/unterstuetzen/alltag" className="mt-3" />
          </div>
        </EditorialSection.Body>
      </EditorialSection>

      {/* ── 2 Orientierung ── EnergieHaushaltVisualisierung
           (verschoben von zwischen Intro und CS1, jetzt nach Hero —
           analog Krise-«ORIENTIERUNG»-Pattern) */}
      <EditorialSection variant="cream">
        <EditorialSection.MarginNote>
          <span
            className="block text-[13px] font-medium uppercase"
      ...
      {/* ── 4 Group A: Was belastet, was hilft ── CS1 alltagsspannung + CS2 was-hilft */}
      <EditorialSection variant="cream">
        <EditorialSection.MarginNote>
          <span
            className="block text-[13px] font-medium uppercase"
          ...
          >
            ...
            <div className="mt-4">
              <EditorialPullQuote>
                ...
                bedeutet sie, Beziehungen etwas vorhersehbarer, klarer und
                weniger reaktiv zu machen.
              </EditorialPullQuote>
            </div>
            <figure
      ...
      {/* ── 5 Group B: Verbindung halten ── CS3 rueckzug + CS4 achtsamkeit + CS5 inseln */}
      <EditorialSection variant="cream">
        <EditorialSection.MarginNote>
          <span
            className="block text-[13px] font-medium uppercase"
            ...
            <div className="mt-6 grid gap-8 sm:grid-cols-2">
              <div>
                ...
                <ul className="mt-3 ml-5 list-disc space-y-2" style={bodyStyle}>
                  ...
                  <li>
                    zwischen Raum geben und Beziehungsabbruch unterscheiden
                  </li>
                </ul>
              </div>
              <div>
      ...
      {/* ── 6 Group C: Konkrete Alltagshilfe ── CS6 konkrete-schritte */}
      <EditorialSection variant="cream">
        <EditorialSection.MarginNote>
          <span
            className="block text-[13px] font-medium uppercase"
      ...
      {/* ── 7 Group D: Wenn es schwer wird ── CS7 impulsivität + CS8 grenzen-alltag */}
      <EditorialSection variant="cream">
        <EditorialSection.MarginNote>
          <span
            className="block text-[13px] font-medium uppercase"
          ...
          >
            <EditorialProse>
              ...
              <p>
                ...
                abrupte Ortsveränderungen. Für Angehörige kann das
                überraschender und belastender sein als depressive Phasen – weil
                es Konsequenzen hat, die beide betreffen.
              </p>
            </EditorialProse>
            ...
            <div className="mt-8">
              <EditorialPullQuote>
                ...
                Druck, nicht aus Rücksichtslosigkeit oder bösem Willen.
              </EditorialPullQuote>
            </div>
            ...
            <div className="mt-10">
              ...
              <p className="mt-2" style={bodyStyle}>
                ...
                Beides braucht eine ruhige Antwort: Anerkennen, was passiert
                ist, ohne es kleinzureden oder aufzubauschen. Erst wenn die
                Emotionen sich gelegt haben, ist der Moment für ein echtes
                Gespräch über Konsequenzen und nächste Schritte.
              </p>
            </div>
          </ContentSection>
