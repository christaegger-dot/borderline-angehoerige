        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              Angehörige möchten oft gleichzeitig beruhigen, schützen,
              verstehen, Grenzen wahren und die Beziehung nicht verlieren. Genau
              diese Gleichzeitigkeit macht die Rolle so anspruchsvoll. Diese
              Seite hilft Ihnen, Unterstützung realistischer und tragfähiger zu
              denken.
            </p>
          </motion.div>
        </div>
