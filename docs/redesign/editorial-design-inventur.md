...
4. **Brief Phase 7 erwähnt 149 MB stale Infografiken** im `/dev/`-Bereich — ich sehe in `_dev/screenshots/` nur ~6 MB an Screenshots. Wo sind die restlichen 149 MB? (Möglicherweise in einem anderen Verzeichnis, das aus meinem Sichtfeld fällt — bitte prüfen.)
