...
4. **Brief Phase 7 erwähnt 149 MB stale Infografiken** — verifiziert (Christa-Hinweis 27.04.): liegen unter `client/public/infografiken/`, nicht `_dev/`. Tatsächlicher Bestand: **47 PNG-Files, 196 MB total**, plus eine **37 MB `infografiken-final.zip`** (nirgends im React-Source referenziert). Phase-7-Cleanup-Posten bestätigt; Volumen sogar grösser als ursprünglich geschätzt.
