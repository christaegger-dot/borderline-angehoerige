...
function buildRoutePrerenderSection(meta: StaticRouteHeadMetadata) {
  ...
  return [
    ...
    "          </svg>",
    "        </span>",
    '        <span class="route-prerender-brand-label">Borderline · Hilfe für Angehörige</span>',
    "      </a>",
    "    </div>",
    '    <div class="route-prerender-body">',
    '      <div class="route-prerender-card">',
    '        <div class="route-prerender-main">',
    ...
    "        </div>",
    "        </div>",
    '        <aside class="route-prerender-aside" aria-label="Schnellzugriff">',
    '          <p class="route-prerender-aside-title">Wenn es akut ist, zählt der direkte Weg.</p>',
